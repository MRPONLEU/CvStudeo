...
export default function App() {
  ...
  const fetchSettings = async () => {
    try {
      ...
      if (data.showCustomPromptArea !== undefined) {
        setShowCustomPromptArea(JSON.parse(data.showCustomPromptArea));
      }
    } catch (e) {
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-black text-gray-900 tracking-tight leading-none uppercase">CV Studio</h1>
